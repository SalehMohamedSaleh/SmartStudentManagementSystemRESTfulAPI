    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseInstructors", x => new { x.TeacherId, x.CourseId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseInstructors_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Grades_Score", "[Score] >= 0 AND [Score] <= [MaxScore]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[EnrollmentId] IS NOT NULL AND [Date] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Classrooms_GradeLevel_Section",
                table: "Classrooms",
                columns: new[] { "GradeLevel", "Section" },
                unique: true,
                filter: "[GradeLevel] IS NOT NULL AND [Section] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[StudentId] IS NOT NULL AND [CourseId] IS NOT NULL AND [AcademicYear] IS NOT NULL AND [Semester] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Grades_EnrollmentId_GradeType",
                table: "Grades",
                columns: new[] { "EnrollmentId", "GradeType" },
                unique: true,
                filter: "[EnrollmentId] IS NOT NULL AND [GradeType] IS NOT NULL");
